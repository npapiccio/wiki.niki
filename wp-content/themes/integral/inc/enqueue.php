...
function integral_scripts() {  
    ...
    wp_enqueue_script('integral_flexslider_js', get_template_directory_uri().'/js/flexslider.js', array('jquery'), '2.1', true );
    wp_enqueue_script('integral_jqueryui_js', get_template_directory_uri().'/js/jquery-ui.min.js', array('jquery'), '1.10.3', true );
